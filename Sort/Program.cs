...
namespace Sort
{
    public class Program
    {
        ...
        {
            Debug.Assert(Utility.IsSorted((new SelectionSortRecursive()).Sort(new int[] { 34, 5, 38, 25, 51, 8, 33, 53, 21 })));
            Debug.Assert(Utility.IsSorted((new SelectionSortIterative()).Sort(new int[] { 34, 5, 38, 25, 51, 8, 33, 53, 21 })));
            ...
            ParentChildSort p = new ParentChildSort();
        }
    }
}
